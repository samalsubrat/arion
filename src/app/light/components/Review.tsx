...
const Reviews = () => {
    ...
    return (
      <div >
        <div className="flex w-full">
          <div className="rounded-lg p-10 light-gradient space-y-2 w-full border border-gray-400/70">
            <div className="flex gap-4 items-center">
              ...
              <div>
                ...
                <div className="font-extralight text-sm flex gap-2 items-center text-black">
                  <Check className="size-4 text-[#A1E0DC]" />
                  Verified Purchase
                </div>
              </div>
            </div>
            <p className="text-base md:text-lg font-extralight text-black !leading-normal">
              {review}
            </p>
          </div>
        </div>
  ...
  return (
    <>
      <MaxWidthWrapper>
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-black text-left mb-10">
        ...
        <div className="relative h-[75vh] overflow-hidden">
          <div className="flex flex-col md:flex-row w-full ">
            ...
            <div className="hidden 2xl:flex flex-row w-full mr-2">
              <div className="flex w-full gap-2">
                <Marquee
                  pauseOnHover
                  vertical
                  className="[--duration:20s] w-1/3 flex-shrink-0"
                >
                ...
                <Marquee
                  pauseOnHover
                  vertical
                  className="[--duration:10s] w-1/3 flex-shrink-0"
                >
            ...
            <div className="hidden md:flex 2xl:hidden flex-row w-full">
              <Marquee
                pauseOnHover
                vertical
                className="[--duration:20s] w-1/2 flex-shrink-0"
              >
                {firstRow.map((item, index) => (
                  <ReviewCard
                    key={index}
          ...
          <div className="pointer-events-none absolute inset-x-0 top-0 h-1/3 bg-gradient-to-b from-gray-100"></div>
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-gray-100"></div>
        </div>
      </MaxWidthWrapper>
    </>
  );
...
const items = [
  ...
  },
  {
    ...
    gradientClass:
      "bg-gradient-to-tl from-indigo-500 via-blue-600 to-purple-700",
  },
  {
    name: "Meera",
    review:
    ...
    gradientClass:
      "bg-gradient-to-bl from-pink-400 via-yellow-500 to-orange-600",
  },
  {
    name: "Raj",
    review:
  ...
  },
  {
    ...
    gradientClass:
      "bg-gradient-to-tr from-green-500 via-blue-600 to-purple-700",
  },
  {
    name: "Nikhil",
    review:
    ...
    gradientClass:
      "bg-gradient-to-bl from-blue-400 via-indigo-500 to-purple-600",
  },
];
